...
static void no_func(void) { tui.lamps[0].active = true; }

static void nc_func(void) { tui.lamps[0].active = false; }
...
static tui_lamp_t tui_lamps[] = {
	{20, 4, "[GPIO6 ]", false}, {20, 5, "[GPIO7 ]", false},
	{20, 6, "[GPIO8 ]", false}, {20, 7, "[GPIO9 ]", false},
	{20, 8, "[GPIO10]", false},
};
